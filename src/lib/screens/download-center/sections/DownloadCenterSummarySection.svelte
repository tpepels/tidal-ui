<script lang="ts">
	...
	type Props = {
		...
		queueSource: string | null | undefined;
		localMode: boolean | undefined;
		actionNotice: DownloadCenterActionNotice;
		...
		handleCopyFailureReport: () => void | Promise<void>;
		handleCreateDebugBundle: () => void | Promise<void>;
	};
