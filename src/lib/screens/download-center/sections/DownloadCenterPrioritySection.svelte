<script lang="ts">
	...
	type Props = {
		...
		attentionPreviewJobs: DownloadCenterJob[];
		queuedJobs: DownloadCenterJob[];
		queuedPreviewJobs: DownloadCenterJob[];
		...
		handlePauseAllActive: () => void | Promise<void>;
		handleStopAllActive: () => void | Promise<void>;
		handleResumeAll: () => void | Promise<void>;
		handleManualRefresh: () => void | Promise<void>;
		showDetailedSections: boolean;
		toggleDetailedSections: () => void;
	};
