<script lang="ts">
	...
	import type { AlbumMusicBrainzSectionVM } from '$lib/screens/album/albumViewModel';

	type Props = {
		viewModel: AlbumMusicBrainzSectionVM;
		isLoading: boolean;
		onRefresh: () => void;
...
>
	...
	{#if viewModel.options.length > 0}
		...
		<select
			...
			value={viewModel.selectedReleaseId}
	...
	<p class="ui-action-status">{viewModel.footerNote}</p>
</SectionBlock>
